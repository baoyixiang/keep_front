...
import './othersHomePage.scss'
import BarTakeUp from "../../../common/barTakeUp/barTakeUp";
import NavBar from "../../../common/navBar/navBar";
import Record from "../../../common/record/record";
export default class OthersHomePage extends Component{
  constructor(props) {
    super(props);
    this.book=[];
    this.state = {
    ...
    return(
      <View className="homePage">
        ...
        <View className="homePage_record">
          <Text className="homePage_record_title">Ta的打卡记录</Text>
